...
public class ListMoviesActivity extends Activity implements LoaderManager.LoaderCallbacks<Cursor>{

    public final static String ID = "com.example.movies.ListMoviesActivity.ID";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdapterView.OnItemClickListener moviesListener = new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                Intent intent = new Intent(ListMoviesActivity.this, DisplayMovieActivity.class);
